    ...
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-6 px-6 py-8 text-slate-100">
      ...
      <section className="grid gap-4 rounded-xl border border-slate-700 bg-slate-900/60 p-4 md:grid-cols-3">
        ...
        <label className="flex flex-col gap-1">
          ...
          <select
            value={resolution}
            onChange={(event) =>
              setResolution(Number(event.target.value) as ResolutionPreset)
            }
          >
        ...
        <label className="flex flex-col gap-1">
          ...
          <input
            ...
            max={20}
            value={stepsPerChunk}
            onChange={(event) => setStepsPerChunk(Number(event.target.value))}
          />
        </label>
        <label className="flex flex-col gap-1">
          Style weight
        ...
        <label className="flex flex-col gap-1">
          ...
          <select
            value={optimizer}
            onChange={(event) =>
              setOptimizer(event.target.value as OptimizerMode)
            }
          >
        ...
        <label className="flex items-center gap-2">
          <input
            type="checkbox"
            checked={fusedOps}
            onChange={(event) => setFusedOps(event.target.checked)}
          />
        ...
        <label className="flex items-center gap-2">
          <input
            type="checkbox"
            checked={superFusedOps}
            onChange={(event) => setSuperFusedOps(event.target.checked)}
          />
          ...
          <>
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                step={0.001}
                value={adamBeta1}
                onChange={(event) => setAdamBeta1(Number(event.target.value))}
              />
            </label>
            <label className="flex flex-col gap-1">
              Adam β2
              <input
                ...
                step={0.001}
                value={adamBeta2}
                onChange={(event) => setAdamBeta2(Number(event.target.value))}
              />
            </label>
            <label className="flex flex-col gap-1">
              Adam ε
              <input
                ...
                step={0.00000001}
                value={adamEpsilon}
                onChange={(event) => setAdamEpsilon(Number(event.target.value))}
              />
            </label>
          </>
        ) : null}
          ...
          <>
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                step={1}
                value={lbfgsMemory}
                onChange={(event) => setLbfgsMemory(Number(event.target.value))}
              />
            </label>
            <label className="flex flex-col gap-1">
              L-BFGS ε
              <input
                ...
                value={lbfgsEpsilon}
                onChange={(event) =>
                  setLbfgsEpsilon(Number(event.target.value))
                }
              />
            </label>
          </>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <img
          ...
          src={contentImage ?? undefined}
          alt="Content"
        />
        <img
          className="aspect-square w-full rounded border border-slate-700 object-cover"
          src={styleImage ?? undefined}
          alt="Style"
        />
        <img
          className="aspect-square w-full rounded border border-slate-700 object-cover"
          src={outputImage ?? undefined}
          alt="Output"
        />
      </section>
