...
export const runContentLossBackward = async (gpuDevice: GPUDevice | null, runUnaryShader: (code: string, input: Float32Array, outCount: number, extraEntries?: GPUBindGroupEntry[]) => Promise<Float32Array>, input: Float32Array, target: Float32Array, BUFFER_USAGE_STORAGE_COPY_DST: number): Promise<Float32Array> => {
